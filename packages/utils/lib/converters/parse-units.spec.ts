...
describe('src/converters/parse-units.ts', () => {
  ...
  it('decimals less than fraction length', () => {
  ...
  it('decimals less than 0 throws error', () => {
    expect(() => parseUnits('69.23521', -1)).toThrowError('DEC_LT_0');
  });

  it('value not number throws error', () => {
    expect(() => parseUnits('Test', 1)).toThrowError('NOT_NUMBER');
  });
});
