...
describe('src/converters/format-units.ts', () => {
  test('converts value to number', () => {
    ...
    expect(formatUnits(12345n, 4)).toMatchInlineSnapshot('"1.2345"');
    expect(formatUnits(6942069420123456789123450000n, 18)).toMatchInlineSnapshot('"6942069420.12345678912345"');
    expect(formatUnits(694212312312306942012345444446789123450000000000000000000000000000000n, 50)).toMatchInlineSnapshot(
